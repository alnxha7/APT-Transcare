...
from .views import (AccountCreditNoteView, AccountCreditTableView,
                    ...
                    SearchReceiptView,AmountReceivableSearchOutstandingSearchView,OutstandingAnalysis,AmountPayableSearchOutstandingSearchView,
...
urlpatterns = [
    ...
    path('get_monthly_rate/', views.get_monthly_rate, name='get_monthly_rate'),
    path('bill_details_ajax/', views.bill_details_ajax, name='bill_details_ajax'),
    ...
    path('accounts/voucher-update/<int:pk>/', views.voucher_update, name='voucher_update'),
    path('accounts/voucher-delete/<int:pk>/', views.voucher_delete, name='voucher_delete'),
    ...
    path('accounts/outstanding-analysis/', OutstandingAnalysis.as_view(), name='outstanding_analysis'),
    path("accounts/amount-receivable/outstanding/search/", AmountReceivableSearchOutstandingSearchView.as_view(), name="amount_receivable_search_outstanding_analysis"),
    path("accounts/amount-payable/outstanding/search/", AmountPayableSearchOutstandingSearchView.as_view(), name="amount_payable_search_outstanding_analysis"),
# item master
    path('item-add/',views.item_add, name='item_add'),
    path('item-list/',views.item_list, name='item_list'),
    path('item-readonly/<int:pk>/',views.item_readonly, name="item_readonly"),
