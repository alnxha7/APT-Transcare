...
class Employee_master(models.Model):
    ...
    km_rate = models.FloatField(null=True, blank=True)
    fixed_km = models.FloatField(null=True, blank=True)
    fixed_charge = models.FloatField(null=True, blank=True)
...
class Vehicle_master(models.Model):
    ...
    chase_number = models.CharField(max_length=50, null=True, blank=True)
...
class VoucherConfiguration(models.Model):
    ...
    fy_year = models.CharField(max_length=100, default='2025-2026')
    ...
    def __str__(self):
        return f"{self.company} - {self.branch} - {self.category} - {self.series} - {self.serial_no}"
...
class Trip_sheet(models.Model):
    ...
    fuel_station=models.CharField(max_length=200, null=True, blank=True)
...
class Table_BillItems(models.Model):
    ...
    fixed_km = models.FloatField()
    additional_km = models.FloatField()
    total_charges = models.FloatField()
    additional_charge = models.FloatField()
    fixed_or_rental_charge = models.FloatField()
...
class Item_master(models.Model):
    ...
    unit =  models.ForeignKey(UnitMaster, on_delete=models.CASCADE, null=True, blank=True)
    group = models.ForeignKey(GroupMaster, on_delete=models.CASCADE, null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        super().save(*args, **kwargs)  # Save the Item_master first


class Stock(models.Model):
    item_code = models.IntegerField(null=True, blank=True)
    item = models.ForeignKey('Item_master', on_delete=models.CASCADE, null=True, blank=True)
    p_price =  models.FloatField(default=0.00,null=True, blank=True)
    land_coast = models.FloatField(default=0.00,null=True, blank=True)
    price_1 = models.FloatField(default=0.00,null=True, blank=True)
    price_2 = models.FloatField(default=0.00,null=True, blank=True)
    price_3 = models.FloatField(default=0.00,null=True, blank=True)
    mrp = models.FloatField(default=0.00,null=True, blank=True)
    gst = models.ForeignKey(TaxMaster, on_delete=models.CASCADE, null=True, blank=True)
    tax_code = models.CharField(max_length=100 )
    op_stock=models.FloatField(default=0.00,null=True, blank=True)
    op_lc=models.FloatField(default=0.00,null=True, blank=True)
    stock=models.FloatField(default=0.00,null=True, blank=True)
